...
export function EditDepartment({ data, id, title, reload }) {
	...
	const hasCannedResponsesLicese = useHasLicense('canned-responses');
	const cannedResponsesEnabled = useSetting('Canned_Responses_Enable');
	const showCanned = true;
	...
	return <Page flexDirection='row'>
		<Page>
			<Page.Header title={title}>
				<ButtonGroup>
					{showCanned && <Button onClick={handleOpenCannedResponses}><Icon name='baloon-exclamation'/> {t('Canned Responses')}</Button>}
